...
eller kraftigt underlättar dina studier.

För de flesta tjänster krävs det ett aktiverat studentkonto.
Detta studentkonto är obligatoriskt för dina studier vid på Uppsala universitet.


## Innehåll

- [Studentkonto](#studentkonto)
...
*Studenter får även information via antagningsbeskedet om hur de aktiverar sitt
studentkonto*

Efter att antagningsresultat registrerats av Uppsala Universitet
öppnas kontoaktiveringen.

Om du har blivit antagen för studier vid Uppsala Universitet kan du klicka på
[denna länk](http://www.uu.se/konto) för att aktivera ditt studentkonto.
Det finns ett [antal sätt](http://akka.uadm.uu.se/engangskod/) att logga in på
aktiveringssidan.

Efter att ha fyllt i dina uppgifter blir du vidarebefodrad till
Studentportalen.
...
[Studentportalen](https://studentportalen.uu.se) används på de flesta av de
kurser du kommer läsa för att hantera bland annat
kursregistrering, kursinformation, schema, inlämning och rättning av uppgifter,
gruppindelningar samt anmälan till tentamen. 
...
till dig, är det viktigt att de stämmer. Kontrollera dina uppgifter och ändra om så
behövs.
...
som fil. Vidare kan du också ställa in hur schemat ser ut, om du föredrar en viss
formatering.
...
[Teknats mobila hemsida](http://m.teknat.uu.se/#timetable) kan också visa schema och fungerar ofta när
...
Observera att vissa tider och klassrum kan ändras, varför det är bra att
...
## Utskrift
I dagsläget används systemet [Korint](http://www.korint.uu.se/).
Inför din första utskrift behöver du ett PayEx-konto. Det finns olika sätt att
...
eller göra utskrifter på 
[kommunala bibliotek](https://www.bibliotekuppsala.se/103783/sv/content-pages/avgifter).
...
automatiskt.
Planerar du att använda trådlöst internet på Campus ofta är det en klar fördel.
